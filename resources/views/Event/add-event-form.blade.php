        ...
        <div class="card-body">
            <form name="add-blog-post-form" id="add-blog-post-form" method="post" action="{{route('event.store')}}">
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" id="event_start" name="event_start" class="form-control" required="">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Konec akce</label>
                    <input type="datetime-local" id="event_end" name="event_end" class="form-control" required="">
                </div>
                <div class="">
                ...
                <div class="form-group">
                    <input type="number" id="participants_count" name="participants_count" min="1" max="50">
                </div>
